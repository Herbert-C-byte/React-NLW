          ...
          <div className="space-y-4">
            <div className="h-16 bg-zinc-900 px-4 rounded-xl flex items-center gap-3">
              <div className="flex items-center gap-2 flex-1">
                ...
                <input type="text" disabled={isGuestsOpen} placeholder="Para onde vai?" className="bg-transparent text-lg placeholder-zinc-400 outline-none flex-1"/>
              </div>
              <div className="flex items-center gap-2">
                <Calendar className="size-5 text-zinc-400" />
                <input type="text" disabled={isGuestsOpen} placeholder="Quando?" className="bg-transparent text-lg placeholder-zinc-400 w-4g  0 outline-none"/>
              </div>
